...
using LangGraph, powered by Google Gemini 1.5 Flash (free tier).
...
# ======================================================================
# LLM ACCESS (Gemini 1.5 Flash, free tier via Google AI Studio)
# ======================================================================
...
with st.sidebar:
    ...
    status = "🟢 Live — Gemini 1.5 Flash" if st.session_state._llm else "🟡 Demo mode — mock agents"
    st.caption(status)
    st.divider()
...
st.caption("Global COO orchestrating autonomous startup families via LangGraph + Gemini 1.5 Flash")
